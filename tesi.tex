...
\input{capitoli/capitolo-2}             % Il progetto nella strategia aziendale
\input{capitoli/capitolo-3}             % Descrizione dello stage
...
\input{capitoli/capitolo-7}             % Valutazione retrospettiva
\appendix                               
\input{capitoli/capitolo-A}             % Appendice A
%\input{capitoli/capitolo-B}				% Appendice B
...
\printglossary[type=\acronymtype, toctitle=Acronimi]
%\printglossaries
